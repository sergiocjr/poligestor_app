...
void main() {
  group('AuthMode Fase 16 CRM paths', () {
    test('exposes official /v1/crm namespace', () {
      ...
      expect(m.crmLeadersPath, '/v1/crm/leaders');
      expect(m.crmSupportersPath, '/v1/crm/supporters');
      expect(m.crmVotersPath, '/v1/crm/voters');
      expect(m.crmVolunteersPath, '/v1/crm/volunteers');
      expect(m.crmTeamPath, '/v1/crm/team');
      expect(m.crmEntitiesPath, '/v1/crm/entities');
      expect(m.crmAssociationsPath, '/v1/crm/associations');
      expect(m.crmChurchesPath, '/v1/crm/churches');
      expect(m.crmCompaniesPath, '/v1/crm/companies');
      expect(m.crmInfluencersPath, '/v1/crm/influencers');
      expect(m.crmSegmentationPath, '/v1/crm/segmentation');
      ...
      expect(m.crmRelationshipHistoryPath, '/v1/crm/relationship-history');
      expect(m.crmInteractionsPath, '/v1/crm/interactions');
      expect(m.crmVisitsPath, '/v1/crm/visits');
      expect(m.crmCallsPath, '/v1/crm/calls');
      expect(m.crmMessagesPath, '/v1/crm/messages');
      expect(m.crmMeetingsPath, '/v1/crm/meetings');
      expect(m.crmLinkedDemandsPath, '/v1/crm/linked-demands');
      expect(m.crmLinkedProtocolsPath, '/v1/crm/linked-protocols');
      expect(m.crmCampaignsPath, '/v1/crm/campaigns');
      expect(m.crmTasksPath, '/v1/crm/tasks');
      expect(m.crmRemindersPath, '/v1/crm/reminders');
      expect(m.crmSupportLevelPath, '/v1/crm/support-level');
      expect(m.crmInfluencePotentialPath, '/v1/crm/influence-potential');
      expect(m.crmRelationshipsPath, '/v1/crm/relationships');
      expect(m.crmImportPath, '/v1/crm/import');
      expect(m.crmExportPath, '/v1/crm/export');
      expect(m.crmSearchPath, '/v1/crm/search');
      expect(m.crmFiltersPath, '/v1/crm/filters');
      expect(m.crmIndicatorsPath, '/v1/crm/indicators');
