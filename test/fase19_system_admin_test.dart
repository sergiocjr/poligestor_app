...
void main() {
  group('AuthMode Fase 19 Admin paths', () {
    test('exposes official /v1/admin namespace', () {
      ...
      expect(m.adminOfficesPath, '/v1/admin/offices');
      ...
      expect(m.adminSettingsPath, '/v1/admin/settings');
      expect(m.adminLicensingPath, '/v1/admin/licensing');
      ...
      expect(m.adminBackupPath, '/v1/admin/backup');
      expect(m.adminMonitoringPath, '/v1/admin/monitoring');
      expect(m.adminHealthPath, '/v1/admin/health');
      expect(m.adminEmailSettingsPath, '/v1/admin/email-settings');
      expect(
        m.adminNotificationSettingsPath,
        '/v1/admin/notification-settings',
      );
      expect(m.adminStorageSettingsPath, '/v1/admin/storage-settings');
      expect(m.adminReportsPath, '/v1/admin/reports');
      expect(m.adminExportsPath, '/v1/admin/exports');
      expect(m.adminSearchPath, '/v1/admin/search');
      expect(m.adminFiltersPath, '/v1/admin/filters');
    });
  });
