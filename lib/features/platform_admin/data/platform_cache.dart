...
/// Cache por tenant — Fase 20 Portal Administrativo Web.
class PlatformCache {
  PlatformCache({SharedPreferences? prefs})
    : _prefsFuture = prefs != null
          ? Future.value(prefs)
          : SharedPreferences.getInstance();

  final Future<SharedPreferences> _prefsFuture;
  static const _prefix = 'pg_plat_';
