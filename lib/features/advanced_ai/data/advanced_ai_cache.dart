...
/// Cache por tenant — Fase 18 IA Avançada.
class AdvancedAiCache {
  AdvancedAiCache({SharedPreferences? prefs})
    : _prefsFuture = prefs != null
          ? Future.value(prefs)
          : SharedPreferences.getInstance();

  final Future<SharedPreferences> _prefsFuture;
  static const _prefix = 'pg_aai_';
