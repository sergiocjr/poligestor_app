...
/// Cache por tenant — Fase 17 Gestão Eleitoral.
class ElectionsCache {
  ElectionsCache({SharedPreferences? prefs})
    : _prefsFuture = prefs != null
          ? Future.value(prefs)
          : SharedPreferences.getInstance();

  final Future<SharedPreferences> _prefsFuture;
  static const _prefix = 'pg_elec_';
