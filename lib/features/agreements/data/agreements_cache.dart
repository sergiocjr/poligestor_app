...
/// Cache por tenant — Sprint 11.0 Painel de Convênios.
class AgreementsCache {
  AgreementsCache({SharedPreferences? prefs})
    : _prefsFuture = prefs != null
          ? Future.value(prefs)
          : SharedPreferences.getInstance();

  final Future<SharedPreferences> _prefsFuture;
  static const _prefix = 'pg_agree_';
