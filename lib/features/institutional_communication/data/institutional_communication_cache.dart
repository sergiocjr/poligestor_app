...
/// Cache por tenant — Fase 15 Comunicação Institucional.
class InstitutionalCommunicationCache {
  InstitutionalCommunicationCache({SharedPreferences? prefs})
    : _prefsFuture = prefs != null
          ? Future.value(prefs)
          : SharedPreferences.getInstance();

  final Future<SharedPreferences> _prefsFuture;
  static const _prefix = 'pg_ic_';
