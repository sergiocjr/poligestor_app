...
/// Cache por tenant — Fase 22 Integrações.
/// Não persiste segredos (tokens, chaves, webhooks secrets).
class IntegrationsCache {
  IntegrationsCache({SharedPreferences? prefs})
    : _prefsFuture = prefs != null
          ? Future.value(prefs)
          : SharedPreferences.getInstance();

  final Future<SharedPreferences> _prefsFuture;
  static const _prefix = 'pg_int_';
  ...
  Future<void> putMap(
    ...
    final sanitized = stripIntegrationsSecrets(data);
