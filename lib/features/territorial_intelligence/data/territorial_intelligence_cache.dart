...
/// Cache por tenant — Fase 12 Inteligência Territorial.
class TerritorialIntelligenceCache {
  TerritorialIntelligenceCache({SharedPreferences? prefs})
    : _prefsFuture = prefs != null
          ? Future.value(prefs)
          : SharedPreferences.getInstance();

  final Future<SharedPreferences> _prefsFuture;
  static const _prefix = 'pg_ti_';
